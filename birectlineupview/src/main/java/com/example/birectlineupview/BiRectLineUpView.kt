...
fun Canvas.drawBiRectLineUp(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawBRLUNode(i : Int, scale : Float, paint : Paint) {
...
class BiRectLineUpView(ctx : Context) : View(ctx) {
    ...
    data class BiRectLineUp(var i : Int) {

        private var curr : BRLUNode = BRLUNode(0)
